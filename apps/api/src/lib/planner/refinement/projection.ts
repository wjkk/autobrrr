...
import { buildFallbackPlannerStructuredDoc, plannerStructuredDocSchema, type PlannerStructuredDoc } from '../doc/planner-doc.js';
import { buildPlannerEntityFingerprint } from '../entity/fingerprint.js';
